...
namespace SafeExamBrowser.Settings.Server
{
	...
	public class ServerSettings
	{
		...
		{
#if RELAXED_MODE
			// Relaxed mode defaults - certificate pinning and validation handled elsewhere
			// No specific properties to set here, but this marks the class as relaxed-mode aware
#endif
