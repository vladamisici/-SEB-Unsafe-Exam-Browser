...
namespace SafeExamBrowser.Settings.Security
{
	...
	public class SecuritySettings
	{
		...
		{
#if RELAXED_MODE
			// Relaxed mode defaults - disable all security restrictions
			KioskMode = KioskMode.None;
			ClipboardPolicy = ClipboardPolicy.Allow;
			VirtualMachinePolicy = VirtualMachinePolicy.Allow;
			AllowWindowCapture = true;
			VerifySessionIntegrity = false;
			VerifyCursorConfiguration = false;
			DisableSessionChangeLockScreen = true;
